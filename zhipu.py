    ...
    try:
        ...
        completion = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user",
                 "content": asr_text + "  请针对以上这段中的“## 视频ASR文本：”部分进行标点符号的补全，如果有明显错别字，请一并修订。直接输出结果，不需要给出修改提示。"
                                       "最后，请给出这篇文章的金句，反常识观点，钩子语句，格式为：金句：xxx \n 反常识观点：xxx\n 钩子语句：xxx\n"}
        ...
        result =  (result.replace("', refusal=None, role='assistant', function_call=None, tool_calls=None)","").replace("', refusal=None, role='assistant', function_call=None, tool_calls=None)","")
                   .replace("。）", "。")
